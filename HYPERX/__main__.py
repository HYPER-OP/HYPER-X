...
from HYPERX.modules import ALL_MODULES
from HYPERX.modules.helper_funcs.chat_status import is_user_admin
from HYPERX.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
Hey There! I'm *𝙷𝚈𝙿𝙴𝚁 𝐗* 

A Super Fast And Advance Group Management Bot Here To Help You Manage Your Chat's Effeciently.
Press /help Or *Help* Button Below To Know More About How To Use Me In Full Potential.

Wanna Add Me To Your Group? Then Click On The Below Button To Add Me In Your Group[.](https://telegra.ph/file/71406119a6df4203ffb44.jpg)
"""
...
HELP_STRINGS = """
Hey There! My Name Is *𝙷𝚈𝙿𝙴𝚁 𝐗*.
I'm Here To Help You Manage Your Chats Easily!
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("HYPERX.modules." + module_name)
...
def innexia_about_callback(update, context):
    ...
    if query.data == "innexia_":
        query.message.edit_text(
            text=""" **HYPER X** it's online since 29 March 2021 and it's constantly updated!
            \n**Bot Admins**
            
            \n• @ITS_KING_HYPER, bot creator and main developer.
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "𝙷𝚈𝙿𝙴𝚁𝐗 𝙸𝚂 𝙱𝙰𝙲𝙺 𝙸𝙽 𝙰𝙲𝚃𝙸𝙾𝙽🔥")
        except Unauthorized:
            LOGGER.warning(
