...
from HYPERX.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
from HYPERX.modules.redis.afk_redis import start_afk, end_afk, is_user_afk, afk_reason
from HYPERX import REDIS
from HYPERX.modules.users import get_user_id

from HYPERX.modules.helper_funcs.alternate import send_message
from HYPERX.modules.helper_funcs.readable_time import get_readable_time
    ...
    if is_user_afk(user_id):
        ...
        if reason == "none":
            if int(userc_id) == int(user_id):
                return
            res = "{} is AFK!\nSince: {} ago.".format(fst_name, since_afk)
