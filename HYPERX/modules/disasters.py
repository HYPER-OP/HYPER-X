...
from HYPERX.modules.log_channel import gloggable
from telegram import ParseMode, TelegramError, Update
from telegram.ext import CallbackContext, CommandHandler, run_async
from telegram.utils.helpers import mention_html

ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "HYPERX/elevated_users.json")
...
def devlist(update: Update, context: CallbackContext):
    ...
    reply = "<b>ʙɪᴏɴɪᴄ ʀᴏʙᴏᴛs ᴍᴇᴍʙᴇʀs ⚡️:</b>\n"
...
# *Global Blue Text*
#  ❍ /gignoreblue*:* <word>*:* Globally ignorea bluetext cleaning of saved word across HYPERX.
...
UNWHITELIST_HANDLER = CommandHandler(("rmwhitelist", "rmwolf"), removewhitelist)
