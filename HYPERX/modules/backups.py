...
import HYPERX.modules.sql.notes_sql as sql
from HYPERX import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from HYPERX.__main__ import DATA_IMPORT
from HYPERX.modules.helper_funcs.chat_status import user_admin
from HYPERX.modules.helper_funcs.alternate import typing_action

# from HYPERX.modules.rules import get_rules
import HYPERX.modules.sql.rules_sql as rulessql

# from HYPERX.modules.sql import warns_sql as warnssql
import HYPERX.modules.sql.blacklist_sql as blacklistsql
from HYPERX.modules.sql import disable_sql as disabledsql

# from HYPERX.modules.sql import cust_filters_sql as filtersql
# import HYPERX.modules.sql.welcome_sql as welcsql
import HYPERX.modules.sql.locks_sql as locksql
from HYPERX.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("HYPERX{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("HYPERX{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `HYPERX-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("HYPERX{}.backup".format(chat_id))  # Cleaning file
