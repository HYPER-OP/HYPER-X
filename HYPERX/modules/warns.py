...
import telegram
from HYPERX import TIGERS, WOLVES, dispatcher
...
from HYPERX.modules.helper_funcs.string_handling import split_quotes
from HYPERX.modules.log_channel import loggable
from HYPERX.modules.sql import warns_sql as sql
