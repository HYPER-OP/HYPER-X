...
import HYPERX.modules.sql.welcome_sql as sql
import HYPERX
from HYPERX import (
    DEV_USERS,
    LOGGER,
...
from HYPERX.modules.helper_funcs.msg_types import get_welcome_type
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            # Give the devs a special goodbye
                ...
                update.effective_message.reply_text(
                    "See you later at the ʙɪᴏɴɪᴄ sᴜᴘᴘᴏʀᴛ!",
                    reply_to_message_id=reply,
                )
                return
