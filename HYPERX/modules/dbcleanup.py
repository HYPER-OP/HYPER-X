...
import HYPERX.modules.sql.global_bans_sql as gban_sql
import HYPERX.modules.sql.users_sql as user_sql
from HYPERX import DEV_USERS, OWNER_ID, dispatcher
from HYPERX.modules.helper_funcs.chat_status import dev_plus
