...
import HYPERX.modules.sql.global_mutes_sql as sql
from HYPERX import dispatcher, OWNER_ID, DRAGONS, STRICT_GMUTE
from HYPERX.modules.helper_funcs.chat_status import user_admin, is_user_admin
...
from HYPERX.modules.sql.users_sql import get_all_chats
    ...
    for chat in chats:
        ...
        try:
            ...
            if excp.message == "User is an administrator of the chat":
                ...
                send_to_list(bot, DRAGONS, "Could not gmute due to: {}".format(excp.message))
                sql.ungmute_user(user_id)
                return
        except TelegramError:
            pass

    send_to_list(bot, DRAGONS, "gmute complete!")
...
def ungmute(bot: Bot, update: Update, args: List[str]):
    ...
    send_to_list(bot, DRAGONS, "un-gmute complete!")
