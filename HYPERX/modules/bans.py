...
from HYPERX.modules.helper_funcs.extraction import extract_user_and_text
from HYPERX.modules.helper_funcs.string_handling import extract_time
from HYPERX.modules.log_channel import gloggable, loggable
...
def kickme(update: Update, context: CallbackContext):
    ...
    if res:
        ...
        update.effective_message.reply_text("Huh? I can't kick you.")
